...
# tmpfiles.d for gunicorn socket directory
lines.append("  # --- tmpfiles for gunicorn socket ---")
lines.append("  - path: /etc/tmpfiles.d/ebike-shop.conf")
lines.append("    content: |")
lines.append("      d /run/ebike-shop 0755 www-data www-data -")
lines.append("")
...
lines.append("          --bind unix:/run/ebike-shop/ebike-shop.sock " + BS)
...
lines.append("              proxy_pass http://unix:/run/ebike-shop/ebike-shop.sock;")
...
lines.append("      BRANCH=" + Q + DS + DS + OB + "1:-master" + CB + Q)
lines.append("")
...
lines.append("runcmd:")
lines.append("  # Clone the repo (preserve .env written by write_files)")
lines.append("  - mv /opt/ebike-shop/.env /tmp/ebike-env 2>/dev/null; rm -rf /opt/ebike-shop; git clone --branch " + Q + tf("repo_branch") + Q + " " + Q + tf("repo_url") + Q + " /opt/ebike-shop; mv /tmp/ebike-env /opt/ebike-shop/.env 2>/dev/null || true")
lines.append("")
